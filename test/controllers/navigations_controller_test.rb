...
class NavigationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create navigation" do
    assert_difference('Navigation.count') do
      post navigations_url, params: { navigation: { name: @navigation.name, pos: @navigation.pos, url: @navigation.url } }
    end
  ...
  test "should update navigation" do
    patch navigation_url(@navigation), params: { navigation: { name: @navigation.name, pos: @navigation.pos, url: @navigation.url } }
